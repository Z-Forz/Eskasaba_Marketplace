...
class SchoolApiService
{
    ...
    {
        $this->baseUrl      = rtrim(env('SIPINTU_BASE_URL', config('services.sipintu.base_url', config('services.sipintu.url', config('services.school_api.url', 'https://sipintu.smkn1bangsri.sch.id')))), '/');
