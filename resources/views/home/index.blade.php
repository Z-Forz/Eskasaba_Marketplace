                ...
                <div class="relative">
                    ...
                    <div class="overflow-hidden rounded-3xl border border-emerald-500/20 bg-slate-900/60 shadow-2xl backdrop-blur-xl">
                        ...
                        @else
                            ...
                            <div class="flex aspect-4/3 items-center justify-center bg-linear-to-br from-emerald-950 to-slate-900">
                                <div class="text-center p-8">
                                    ...
                                    <p class="mt-1 text-xs text-emerald-200/70">Wadah Kewirausahaan Digital SMKN 1 Bantul</p>
    ...
    <section class="border-b border-slate-100 bg-white">
        <div class="mx-auto grid max-w-7xl grid-cols-1 divide-y divide-slate-100 px-4 sm:grid-cols-3 sm:divide-x sm:divide-y-0 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-4 px-0 py-6 sm:px-6 lg:py-8">
                <div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-emerald-50 text-emerald-800 border border-emerald-100">
    ...
    <section class="bg-slate-50 py-14 sm:py-16">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-end justify-between gap-4">
                ...
                <a
                    href="{{ route('products.index') }}"
                    class="hidden text-sm font-bold text-emerald-800 hover:text-emerald-900 sm:inline-flex items-center gap-1"
                >
