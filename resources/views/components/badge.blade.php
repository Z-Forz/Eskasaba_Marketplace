...
@php
    $classes = match ($type) {
        'success', 'completed', 'paid', 'verified', 'refunded', 'returned' => 'bg-emerald-50 text-emerald-800 ring-emerald-200/60 dark:bg-emerald-950/60 dark:text-emerald-300 dark:ring-emerald-800',
