...
@php
    $classes = match ($type) {
        'success', 'completed', 'paid', 'verified', 'refunded', 'returned', 'cancelled' => 'bg-emerald-50 text-emerald-800 ring-emerald-200/60 dark:bg-emerald-950/60 dark:text-emerald-300 dark:ring-emerald-800',
        ...
        'cancel_requested', 'return_requested', 'refund_pending_buyer_confirmation' => 'bg-orange-50 text-orange-800 ring-orange-200/60 dark:bg-orange-950/60 dark:text-orange-300 dark:ring-orange-800',
        'danger', 'rejected' => 'bg-red-50 text-red-800 ring-red-200/60 dark:bg-red-950/60 dark:text-red-300 dark:ring-red-800',
